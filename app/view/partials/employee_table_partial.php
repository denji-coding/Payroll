...
<tr class="employee-row transition-opacity duration-500 opacity-100" data-id="<?= $emp['id'] ?>">

    <td class="p-3 align-middle font-medium"><?= $index++ ?></td>
        ...
        <div class="flex items-center space-x-2">
            <span class="relative flex shrink-0 overflow-hidden rounded-full h-12 w-12">
                <?php if (!empty($emp['photo_path'])): ?>
                    <img class="aspect-square h-full w-full" src="<?= htmlspecialchars($emp['photo_path']) ?>" alt="Employee Photo">
                <?php else: ?>
                    <?php
    ...
    <td class="p-3 align-middle"><?= htmlspecialchars($emp['employee_no']) ?></td>
    <td class="p-3 align-middle"><?= htmlspecialchars($emp['rfid_number']) ?></td>
    ...
    <td class="p-3 align-middle text-right">
        <div class="flex gap-2">
            <button type="button"
                    ...
                    onclick="viewEmployee('<?= htmlspecialchars($emp['employee_no']) ?>')">
